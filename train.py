...
def main():
    ...
    if not args.play:
        ...
        # print("==== Evaluating 2I ====")
        # evaluate_tasks(env, policy, "test_tasks_raw_2I.pkl", 50, deterministic=False)
        # print("==== Evaluating Y_v2 shape ====")
        # evaluate_tasks(env, policy, "test_tasks_raw_Y_v2.pkl", 100, deterministic=False)
        print("==== Evaluating 3T ====")
        evaluate_tasks(env, policy, "test_tasks_raw.pkl", 100, deterministic=False)
        print("==== Evaluating I shape ====")
        evaluate_tasks(env, policy, "test_tasks_raw_I.pkl", 100, deterministic=False)
        print("==== Evaluating Y shape ====")
        evaluate_tasks(env, policy, "test_tasks_raw_Y.pkl", 100, deterministic=False)
